...
void bind_surface_mesh(py::module& m) {
  ...
  py::class_<ps::SurfaceMesh>(m, "SurfaceMesh")
      ...
      .def("set_back_face_color", &ps::SurfaceMesh::setBackFaceColor, "Set back face policy")
      .def("get_back_face_color", &ps::SurfaceMesh::getBackFaceColor, "Get back face policy")
